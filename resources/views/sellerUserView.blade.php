                ...
                <table class="min-w-full text-sm text-center divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-800 text-white">
                        <tr>
                            ...
                            <th class="px-4 py-3">نام مشتری </th>
                            <th class="px-4 py-3">نام خانوادگی مشتری</th>
                            <th class="px-4 py-3">ایمیل مشتری</th>
                            <th class="px-4 py-3">شماره مشتری </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach ($telephoneSellerUser as $user)
                            <tr>
